...
def generate_section(prompt, model_name, temperature, openai_api_key):
...
def article_generator_core(subject, num_sections):
    ...
    article = generate_section(intro_prompt, model_name, temperature, openai_api_key)
    ...
    for _ in range(num_sections):
        ...
        next_topic = generate_section(next_section_prompt, model_name, temperature, openai_api_key)
        ...
        next_section_content = generate_section(content_prompt, model_name, temperature, openai_api_key)
...
def article_generator_core_ui():
    ...
    if not subject:
        ...
        st.info("Performing")
        st.session_state["response"] = article_generator_core(subject,number_of_sections)
